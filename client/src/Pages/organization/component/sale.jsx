...
const OrgSale = () => {
  ...
  useEffect(() => {
    const getCars = async () => {
      try {
        ...
        const orgCars = allCars.filter(car => car.owner === currentUser._id  & car.carType === "sell") // Assuming `owner` is the organization ID in the car data
        setCars(orgCars);
  ...
  return (
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="mt-2">
      <p className='bg-blue-500 px-2 rounded-lg text-white'>Total Cars for Sale: {sellCount}</p> {/* Display the count */}
