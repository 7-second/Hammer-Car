  ...
  <div className="flex flex-col w-full">
        ...
        <div className="hidden md:flex flex-row mt-8 flex-wrap  justify-evenly shadow-2xl shadow-emerald-700 pb-4">
             <div className="w-[200px] shadow-2xl rounded-md bg-pink-500 shadow-yellow-500">
                ...
                <img 
                className="w-fit h-[200px]"
                src="https://www.svgrepo.com/show/25407/car.svg" alt="All cars" />
                   <div className='flex justify-evenly items-center'>
                    <CountUp duration={5} className='text-xl font-semibold ml-2' end={500} />
                     <span className="bg-brown-500 text-blue-400 p-1.5 rounded-md text-sm font-bold" >
                     All Cars</span>
                ...
                <img 
                className="w-fit h-[200px]"
                src="https://www.svgrepo.com/show/28669/rent-a-car.svg" alt="Rented Cars" />
                   <div className='flex justify-evenly items-center'>
                    <CountUp duration={5} className='text-xl font-semibold ml-2' end={500} />
                     <span className="bg-brown-500 text-blue-400 p-1.5 rounded-md text-sm font-bold" >
             ...
             <div className="w-[150px] shadow-2xl rounded-md">
                ...
                <img 
                className="w-fit h-[200px]"
                src="https://www.svgrepo.com/show/25407/car.svg" 
                alt="All cars" />
